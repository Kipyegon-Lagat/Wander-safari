...
const ChatBot = () => {
  ...
  const handleSendMessage = () => {
    ...
    setTimeout(() => {
      ...
      let botResponse = "That's a great question! I'd recommend speaking with one of our safari experts for detailed information. You can contact us through our booking form or call +254 700 123 456.";
